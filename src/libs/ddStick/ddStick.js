(function (e) {
    ...
    var c = {}, d = {
        ...
        b = '<style id="css-ddslick" type="text/css">' +
            ...
            '.dd-selected{height:50px; color:#ffffff; display:flex; align-items: center; overflow:hidden;  padding:5px; font-weight:bold;}.dd-pointer{ width:0; height:0; position:absolute; right:10px; top:50%; margin-top:-3px;}.dd-pointer-down{ border:solid 5px transparent; border-top:solid 5px #ffffff; }.dd-pointer-up{border:solid 5px transparent !important; border-bottom:solid 5px #ffffff !important; margin-top:-8px;}' +
            ...
            '.dd-option:hover{ background:#f3f3f3; color:#000;}.dd-selected-description-truncated { text-overflow: ellipsis; white-space:nowrap; }.dd-option-selected {background:"transparent"; }' +
            '.dd-option-image, ' +
